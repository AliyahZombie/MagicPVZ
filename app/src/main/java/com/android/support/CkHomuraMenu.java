...
//                case "SelectValueXY":
//                    subFeat++;
//                    SelectValueXY(linearLayout, strSplit[1], Integer.parseInt(strSplit[2]), Integer.parseInt(strSplit[3]), Integer.parseInt(strSplit[4]), strSplit[5], Integer.parseInt(strSplit[6]), Integer.parseInt(strSplit[7]), Integer.parseInt(strSplit[8]));
//                    break;
            }
        }
    }
