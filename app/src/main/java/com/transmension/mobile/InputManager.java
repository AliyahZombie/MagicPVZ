...
public interface InputManager {
    ...
    /* loaded from: classes.dex */
    public static class PointerEvent extends InputEvent {
    ...
    @SuppressLint({"NewApi"})
    /* loaded from: classes.dex */
    public static class JoystickEvent extends InputEvent {
        public int mActionIndex = 0;
    ...
    public static class KeyInputEvent extends InputEvent {
        ...
        public static KeyInputEvent translate(KeyEvent keyEvent) {
            ...
            event.mFlags = keyEvent.getSource();
    ...
    /* loaded from: classes.dex */
    public static class SensorInputEvent {
