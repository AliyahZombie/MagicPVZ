...
public class AndroidTextInputManager implements TextInputManager {
    ...
    static /* synthetic */ EditText access$0(AndroidTextInputManager androidTextInputManager) {
        return androidTextInputManager.mTextInput;
    }
    ...
    public void setInputCookie(long cookie) {
        Log.i(TAG, String.format("setInputCookie: 0x%x", Long.valueOf(cookie)));
    ...
    public void setText(String text, int selectionStart, int selectionEnd) {
        ...
        if ((textChanged || selectionChanged) && selectionStart != -1 && selectionEnd != -1) {
    ...
    public void onEndBatchEdit(long cookie) {
        ...
        Log.i(TAG, "Text: " + ((Object) this.mText) + " Selection: " + start + ":" + end);
    ...
    public static class EditableInputConnection extends BaseInputConnection {
        ...
        public boolean commitText(CharSequence text, int newCursorPosition) {
            Log.i(TAG, "commitText: " + ((Object) text) + " at " + newCursorPosition);
    ...
    public void showTextInputDialog(int mode, String title, String hint, String initial) {
        ...
        if (mode == 4 || mode == 1) {
            InputFilter filter = new AnonymousClass1();
        ...
        builder.setNegativeButton("返回", new AnonymousClass3());
        builder.setOnCancelListener(new AnonymousClass4());
        this.mTextInputDialog = builder.create();
        this.mTextInputDialog.show();
    }

    /* renamed from: com.transmension.mobile.AndroidTextInputManager$1  reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    /* renamed from: com.transmension.mobile.AndroidTextInputManager$2  reason: invalid class name */
    /* loaded from: classes.dex */
    class AnonymousClass2 implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialog, int whichButton) {
            AndroidTextInputManager.this.onTextInput(AndroidTextInputManager.access$0(AndroidTextInputManager.this).getText().toString());
        }
    }

    /* renamed from: com.transmension.mobile.AndroidTextInputManager$3  reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    /* renamed from: com.transmension.mobile.AndroidTextInputManager$4  reason: invalid class name */
    /* loaded from: classes.dex */
