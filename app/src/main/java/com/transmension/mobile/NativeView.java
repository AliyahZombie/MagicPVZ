...
public class NativeView extends SurfaceView implements SurfaceHolder.Callback2, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public NativeView(Context context) {
        ...
        keyCodePause = context.getSharedPreferences("data", 0).getInt("keyCodePause", KeyEvent.KEYCODE_S);
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == keyCodePause && event.getRepeatCount() == 0) {
            NativeApp.onPauseNative(mActivity.mNativeHandle);
            NativeApp.onResumeNative(mActivity.mNativeHandle);
        }
